...
from libcachesim import (
    # Basic algorithms
    LRU, FIFO, LFU, ARC, Clock, Random,
    # Advanced algorithms
    S3FIFO, Sieve, LIRS, TwoQ, SLRU, WTinyLFU,
...
class TestCacheBasicFunctionality:
    ...
    @pytest.mark.parametrize("cache_class", [
        LRU, FIFO, LFU, ARC, Clock, Random,
        S3FIFO, Sieve, LIRS, TwoQ, SLRU, WTinyLFU, LeCaR, LFUDA, ClockPro, Cacheus,
        LRUProb, FlashProb, Size, GDSF, Hyperbolic
    ])
